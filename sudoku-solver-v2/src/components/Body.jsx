...
function Body() {
  ...
  return (
    <>
      <div className="py-4 bg-background flex flex-col relative">
        <div className="flex flex-col items-center justify-center gap-4 m-1 sm:flex-row sm:m-4 md:gap-8">
          ...
          <div className="flex flex-row justify-between items-center gap-2 sm:flex-row sm:gap-2">
            <BigBtn
              OnClick={() =>
                setSearchParams({ difficulty: "easy", next: true })
              }
            >
              Easy
            </BigBtn>
            ...
            <BigBtn
              OnClick={() =>
                setSearchParams({ difficulty: "hard", next: true })
              }
            >
              Hard
            </BigBtn>
        ...
        <div className="flex flex-col justify-center items-center my-5 gap-8 lg:flex-row lg:gap-16">
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-8 ">
            ...
            <div className=" flex flex-col items-center justify-center gap-8 md:gap-12">
              ...
              <BigBtn OnClick={() => setShowPopup(true)}>
                <IconLockOpen
        ...
        <div className={showPopup ? "block" : "hidden"}>
          <div className="absolute inset-0 z-20 flex items-center justify-center bg-background bg-opacity-50">
            <div className="w-2/3 bg-background border-2 border-accent p-2 sm:p-5 md:w-1/2 md:p-7 md:border-4 lg:p-10">
              <div className="text-sm text-text text-center border-b-2 border-primary mb-2 sm:text-lg md:text-2xl md:mb-5 lg:text-3xl">
              ...
              <div className="flex flex-row items-center justify-center gap-5 ">
                ...
                <div
                  className="text-base text-text text-center underline hover:cursor-pointer sm:text-xl md:text-3xl"
